...
def find_records():
    if request.method == 'POST':
        ...
        return render_template('index.html', persons=persons, keyword=keyword, show_result=True, developer_name='betul-kaplan')
    else:
        return render_template('index.html', show_result=False, developer_name='betul-kaplan')
